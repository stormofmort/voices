  ...
  <tr>
    <td colspan="3"><table id="componentTable2" width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td><input id="userInput" type="text" name="userName" maxlength="20" value="<?php if(isset($_POST['username'])) { echo $_POST['userName']; } ?>"/></td>
      ...
      <tr>
        ...
        <td><select id="styleList" name="profileStyle">
        	<?php  if(isset($_POST['profileStyle'])) { ?>
            ...
            <?php } else { ?>
            <option value="1" selected="selected">Miminum</option>
            <option value="2">Show Personal Info</option>
            <option value="3">Show Location</option>
            <option value="4">Show Contact Info</option>
            <option value="5">Show Address</option>
            <?php } ?>
        </select></td>
        <td id="error">&nbsp;</td>
      </tr>
      ...
      <tr>
        ...
        <td><input id="userInput" type="text" name="hiddenQ" maxlength="100" value="<?php if (isset($_POST['hiddenQ'])) {echo $_POST['hiddenQ'];} ?>" /></td>
      ...
      <tr>
        ...
        <td><input id="userInput" type="text" name="hiddenA" maxlength="100" value="<?php if (isset($_POST['hiddenA'])) {echo $_POST['hiddenA'];} ?>" /></td>
      ...
      <tr>
        ...
        <td><input id="userInput" type='text' name="firstName" maxlength="40" value="<?php if (isset($_POST['firstName'])) {echo $_POST['firstName'];} ?>" /></td>
      ...
      <tr>
        ...
        <td><input id="userInput" type='text' name="lastName" maxlength="40" value="<?php if (isset($_POST['lastName'])) {echo $_POST['lastName'];} ?>" /></td>
      ...
      <tr>
        ...
        <td><input id="day" type="text" name="day" maxlength="2" value="<?php if (isset($_POST['day'])) {echo $_POST['day'];} ?>" />
            <select name="monthList" id="monthList">
              <?php if(isset($_POST['monthList'])) {?>
            ...
            <input id="year" type="text" name="year" maxlength="4" value="<?php if (isset($_POST['year'])) {echo $_POST['year'];} ?>" />        </td>
      ...
      <tr>
        ...
        <td><input id="userInput" type='text' name="homePhone" maxlength="15" value="<?php if (isset($_POST['homePhone'])) {echo $_POST['homePhone'];} ?>" /></td>
      ...
      <tr>
        ...
        <td><input id="userInput" type='text' name="workPhone" maxlength="15" value="<?php if (isset($_POST['workPhone'])) {echo $_POST['workPhone'];} ?>" /></td>
      ...
      <tr>
        ...
        <td><input id="userInput" type='text' name="mobilePhone" maxlength="15" value="<?php if (isset($_POST['mobilePhone'])) {echo $_POST['mobilePhone'];} ?>" /></td>
      ...
      <tr>
        ...
        <td><input id="userInput" type='text' name="email" maxlength="100" value="<?php if (isset($_POST['email'])) {echo $_POST['email'];} ?>" /></td>
      ...
      <tr>
        ...
        <td><input id="userInput" type="text" name="address" maxlength="100" value="<?php if (isset($_POST['address'])) {echo $_POST['address'];} ?>" /></td>
      ...
      <tr>
        ...
        <td><input id="userInput" type="text" name="street" maxlength="100" value="<?php if (isset($_POST['street'])) {echo $_POST['street'];} ?>" /></td>
      ...
      <tr>
        ...
        <td><input id="userInput" type="text" name="city" maxlength="100" value="<?php if (isset($_POST['city'])) {echo $_POST['city'];} ?>" /></td>
      ...
      <tr>
        ...
        <td><input id="userInput" type="text" name="country" maxlength="100" value="<?php if (isset($_POST['country'])) {echo $_POST['country'];} ?>" /></td>
      ...
      <tr>
        ...
        <td><input id="userInput" type="text" name="ZIPCode" maxlength="10" value="<?php if (isset($_POST['ZIPCode'])) {echo $_POST['ZIPCode'];} ?>" /></td>
      ...
      <tr>
        <td colspan="3" align="center"><table cellpadding="0" cellspacing="0" border="0">
          ...
          <tr>
          	 <?php if(isset($_POST['avatarGroup'])) {?>
            ...
            <td align="center"><input type="radio" name="avatarGroup" value="default_04.png" id="avatarGroup_0" <?php if ($_POST['avatarGroup'] == 'default_04.png') { echo "checked='checked'"; } ?> /></td>
          	<?php } else {?>
          	<td align="center"><input type="radio" name="avatarGroup" value="default_01.png" id="avatarGroup_0" /></td>
            <td align="center"><input type="radio" name="avatarGroup" value="default_02.png" id="avatarGroup_0" /></td>
            <td align="center"><input type="radio" name="avatarGroup" value="default_03.png" id="avatarGroup_0" /></td>
            <td align="center"><input type="radio" name="avatarGroup" value="default_04.png" id="avatarGroup_0" /></td>
          	<?php }?>
          </tr>
          <tr>
